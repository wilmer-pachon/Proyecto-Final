<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/Vista/Roles/Normal/MasterNormal.master" AutoEventWireup="true" CodeFile="~/logica/Normal/muestra_herramienta.aspx.cs" Inherits="Vista_Roles_Normal_muestra_herramienta" %>
            ...
            <td>
                <div id="L">
                      ...
                      <asp:GridView ID="gridcomentarios" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" DataSourceID="muestra_comentarios" GridLines="Horizontal" Height="177px"  Width="431px" CssClass="auto-style3" >
                          <Columns>
                              <asp:BoundField DataField="id_comenta" HeaderText="idcom" />
                              ...
                              <asp:TemplateField HeaderText="responder" ShowHeader="False">
                                  <ItemTemplate>
                                      ...
                                      <br />
                                      <asp:Button ID="respuesta" CommandArgument="id_comenta" CommandName="respuesta" runat="server"  Text="Responder" />
                                      <br />
                                  </ItemTemplate>
                              </asp:TemplateField>
                              <asp:TemplateField HeaderText="Respuestas">
                                  <ItemTemplate>
                                      <asp:GridView ID="GridView2" runat="server" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal" Height="139px" Width="179px" DataSourceID="ver_respuesta" AutoGenerateColumns="False" DataKeyNames="id_responde">
                                          <Columns>
                                              <asp:TemplateField HeaderText="Respuesta">
                                                  <EditItemTemplate>
                                                      <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("respuestas") %>'></asp:TextBox>
                                                  </EditItemTemplate>
                                                  <ItemTemplate>
                                                      <asp:Label ID="Label1" runat="server" Text='<%# Bind("respuestas") %>'></asp:Label>
                                                  </ItemTemplate>
                                              </asp:TemplateField>
                                          </Columns>
