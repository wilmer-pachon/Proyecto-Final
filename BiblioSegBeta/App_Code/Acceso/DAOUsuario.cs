...
{
	  public DataTable registrarUsuario(EUsuario user)
    {
      ...
      public DataTable loginUsuarios(EUsuario usuario)
      {
          DataTable Usuario = new DataTable();
      ...
      public DataTable correoUsuario(EUsuario user)
      {
      ...
      public void loginUsuarios_out(EUsuario user)
      {
      ...
      public DataTable aprobarPuntos(EDHerramienta user)//herramientas pendientess
      {
          DataTable Usuario = new DataTable();
          NpgsqlConnection conectar = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
      ...
      public DataTable total_Puntos(EUsuario user)//herramientas pendientess
      {
          DataTable Usuario = new DataTable();
          NpgsqlConnection conectar = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
