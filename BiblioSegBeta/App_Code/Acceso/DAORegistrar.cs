...
/// <summary>
/// Descripción breve de DAORegistar
/// </summary>
public class DAORegistrar
{
    ...
    public DataTable registrar_usuario(EDatos user)
    {
    ...
    public DataTable registrar_usuario1(EDatos user)
    {
        DataTable Usuario = new DataTable();
        NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["postgres"].ConnectionString);
        try
    ...
    public DataTable enviar_usuario(EDatos user)
    {
        DataTable Usuario = new DataTable();
        NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["postgres"].ConnectionString);
        try
