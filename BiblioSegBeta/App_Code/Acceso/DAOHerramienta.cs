...
/// <summary>
/// Descripción breve de DAOHerramienta
/// </summary>
public class DAOHerramienta
{
	public DAOHerramienta()
	{
		//
    ...
    public DataTable aprobadas(EDHerramienta user)//llamar herramientas aprobadas
    {
        DataTable Usuario = new DataTable();
        NpgsqlConnection conectar = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
    ...
    public DataTable pendientes(EDHerramienta user)//herramientas pendientess
    {
        DataTable Usuario = new DataTable();
        NpgsqlConnection conectar = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
