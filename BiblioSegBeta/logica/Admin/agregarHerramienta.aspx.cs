...
public partial class Vista_Roles_Admin_agregarHerramienta : System.Web.UI.Page
{
    ...
    protected void guardar_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("hagregada.aspx");
    ...
    protected String cargarImagen()
    {
        ...
        string saveLocation = Server.MapPath("~\\Vista\\images") + "\\" + nombreArchivo + rnd.Next(-100, 101);
